...
x3 = traj_u_line(5.75, 6, 1.5, 0)
x4 = traj_u_step(6, 13, 0)
...
# save trajectory
np.savetxt('/home/oem/StanfordMSL/TrajBridge/src/bridge_px4/trajectories/Traj0527_1.5_1s_wreverse_large.csv', X, delimiter=',', fmt='%1.3f')