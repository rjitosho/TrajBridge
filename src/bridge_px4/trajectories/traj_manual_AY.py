...
x3 = traj_u_line(5.75, 6, 1.5, 0.7)
x4 = traj_u_step(6, 10, 1.49)
x5 = traj_u_line(10, 13, 1.49, 0)
...
z2 = traj_u_step(5.5, 5.75, 1.57)
z3 = traj_u_line(5.75, 6, 1.57, 1.57)
z4 = traj_u_step(6, 10, 1.57)
z5 = traj_u_line(10, 13, 1.57, 1.75)
...
# save trajectory
np.savetxt('/home/oem/StanfordMSL/TrajBridge/src/bridge_px4/trajectories/Traj0531_pip11.csv', X, delimiter=',', fmt='%1.3f')