...
x4 = traj_u_step(6, 10, 1.5)
x5 = traj_u_line(10, 13, 1.5, 0)
...
# save trajectory
np.savetxt('/home/oem/StanfordMSL/TrajBridge/src/bridge_px4/trajectories/Traj0531_pip4.csv', X, delimiter=',', fmt='%1.3f')